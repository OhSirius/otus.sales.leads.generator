...
java -Dconfig.file=$CONFIG -DMODE=$MODE -DLOGS_DIR=$LOGS_DIR -Dlogback.configurationFile=$LOGS_CONFIG -Dfile.ending=UTF8  -cp $SCALA_HOME/lib/scala-library.jar  -jar otus-sales-leads-generator-app-api.jar